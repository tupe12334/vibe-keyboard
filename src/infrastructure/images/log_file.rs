...
pub fn generate_log_file_image() -> RgbImage {
    ...
    // Document body
    for y in 15u32..=85 { for x in 25u32..=75 { img.put_pixel(x, y, white); } }

    // Folded top-right corner
    for y in 15u32..=30 { for x in 60u32..=75 { img.put_pixel(x, y, bg); } }
    ...
    for y in [38u32, 48, 58, 68] {
        for x in 33u32..=67 { img.put_pixel(x, y, gray); }
    }
